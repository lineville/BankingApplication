...
public class ListOfAccounts {
    ...
    /**
     * A ListOfAccounts has an ArrayList of accounts, one account can be
     * selected, it can either be in savingsMode, checkingMode or allMode.
     */
    ...
    public Account getAccount(String name){
        ...
        if(result == null) return new Account("Sorry, Couldn't Find that Account!"
                , 0.0, "Not an Account");
        return result;
    }
    ...
    /**
     * Formats the names to a nice looking String
    ...
    /**
     * Formats the balances to a nice looking String
     * @return String of balances
     */
